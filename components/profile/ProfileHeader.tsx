      ...
      <div className="flex items-center gap-3 sm:gap-4 pl-12 md:pl-0">
        ...
        <div className="flex flex-col min-w-0">
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            <h1 className="text-base sm:text-xl font-semibold text-text-primary tracking-tight whitespace-nowrap">Vandan</h1>
            <span className="hidden xs:inline-flex px-2.5 py-0.5 rounded-full bg-surface-card border border-border-subtle text-[11px] font-medium text-text-primary/80 whitespace-nowrap">
              Free plan
            </span>
          </div>
          <p className="text-[12px] sm:text-[13px] text-text-secondary mt-0.5 truncate">
            vandan@toteminteractive.com
          </p>
        </div>
      </div>
